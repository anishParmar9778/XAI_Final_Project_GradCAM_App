...
Streamlit app for XAI Final Project. Allows a user to highlight regions of an image that they think is important for model classification and compare it against the GradCAM heatmap from a CNN using IoU.
